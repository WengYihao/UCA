...
public class WorldPrintAdapter extends BaseAdapter {
    private List<WorldCountryBean> list;
    private Context context;
    private int TypeOne = 0;// 注意这个不同布局的类型起始值必须从0开始
    private int TypeTwo = 1;

    public WorldPrintAdapter(List<WorldCountryBean> list, Context context) {
        this.list = list;
        this.context = context;
    }
    public void setList(List<WorldCountryBean> list) {
        if (list != null) {
            this.list =  list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (type){
            case 0:
                ...
                holder.place.setText(list.get(position).getCountry_name());
            ...
            case 1:
                ...
                holder2.place.setText(list.get(position).getCountry_name());
