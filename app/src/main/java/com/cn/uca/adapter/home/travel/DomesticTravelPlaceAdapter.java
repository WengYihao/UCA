...
public class  	DomesticTravelPlaceAdapter extends BaseAdapter{
	...
	public DomesticTravelPlaceAdapter(){}
	public DomesticTravelPlaceAdapter(List<DomesticTravelPlaceBean> list, Context context) {
		this.list = list;
		this.context = context;
	}
	public DomesticTravelPlaceAdapter(List<DomesticTravelPlaceBean> list, Context context, int height, int width) {
		this.list = list;
		this.context = context;
		this.height = height;
		this.width = width;
	}
	public void setList(List<DomesticTravelPlaceBean> list) {
		if (list != null) {
			this.list = (List<DomesticTravelPlaceBean>) list;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		Uri uri = Uri.parse(list.get(position).getCity_picture_url());
