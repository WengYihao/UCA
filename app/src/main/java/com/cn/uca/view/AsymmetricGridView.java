 ...
 */
public class AsymmetricGridView extends com.felipecsl.asymmetricgridview.library.widget.AsymmetricGridView {
    ...
    public AsymmetricGridView(Context context, AttributeSet attrs) {
        ...
        requestedVerticalSpacing = Utils.dpToPx(context,1);
    ...
    public void setRequestedVerticalSpacing(int width){
        requestedVerticalSpacing  = width;
    }
...
//            ss.adapterState = gridAdapter.saveState();
    ...
    public void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof com.felipecsl.asymmetricgridview.library.widget.AsymmetricGridView.SavedState)) {
