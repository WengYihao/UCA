...
import com.cn.uca.R;
import com.cn.uca.adapter.user.OrderMessageAdapter;
...
public class OrderMessageActivity extends BaseBackActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        list = new ArrayList<>();
        adapter = new OrderMessageAdapter(list,this);
    ...
    private void getPushUser(int page,int pageCount){
        ...
        map.put("push_type","order");
        String time_stamp = SystemUtil.getCurrentDate2();
        map.put("time_stamp",time_stamp);
        String sign = SignUtil.sign(map);
        UserHttp.getPushUser(sign, time_stamp, account_token, page, pageCount, "order", new CallBack() {
            @Override
