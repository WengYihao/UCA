...
public class YuekaActivity extends BaseBackActivity implements AMapLocationListener,View.OnClickListener,OnDoubleSureLisener,CollectionClickListener,SearchCallBack {

    private ListView listView;
    private YueKaAdapter yueKaAdapter;
    private List<EscortRecordsBean> list;
    private TextView back,place,orderYue,freeTime,all;
    ...
    private void ininView() {
        ...
        orderYue = (TextView) findViewById(R.id.orderYue);
        listView = (ListView) findViewById(R.id.listView);
        freeTime = (TextView) findViewById(R.id.freeTime);

        yueka_num = (TextView)findViewById(R.id.yueka_num);
        ...
        list = new ArrayList<>();
        yueKaAdapter = new YueKaAdapter(list, this, this);
        listView.setAdapter(yueKaAdapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent();
                intent.setClass(YuekaActivity.this, YueChatActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.place:
                ...
                break;
            case R.id.all:
                new YuekaSearchPopupWindow(this,all,this);
                break;
            case R.id.orderYue:
                if (SharePreferenceXutil.isSuccess()){
                    if (SharePreferenceXutil.isAuthentication()){
                        startActivity(new Intent(this, OrderYueActivity.class));
                    }else{
                        startActivity(new Intent(this, OtherYueActivity.class));
                    }
                }else{
    ...
    public void onResume() {
        ...
        if (MessageNumBean.getInstens().getE_purchase() != 0 ||
            ...
            yueka_num.setVisibility(View.VISIBLE);
        }else{
            yueka_num.setVisibility(View.GONE);
        }
    }
