...
//旅拍订单详情
public class LvPaiOrderDetailActivity extends BaseBackActivity implements View.OnClickListener,PayBack{

    private TextView back,name,state,order,place,date,style,price,config;
    private ImageView pic;
    private LvPaiOrderInfo info;
    private int id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lv_pai_order_detail);
                    ...
                    public void onResponse(Object response) {
                        try{
                            ...
                            switch (code){
                                case 0:
                                    Gson gson = new Gson();
                                    info = gson.fromJson(jsonObject.getJSONObject("data").toString(),new TypeToken<LvPaiOrderInfo>() {
                                    }.getType());
                                    ...
                                    style.setText(StringXutil.ListtoString(info.getStyle_lable()));
        ...
        switch (v.getId()){
            ...
            case R.id.config:
                switch (info.getUser_order_state_id()){
                    case 2:
                        //支付
                        ShowPopupWindow.paymentWindow(this,"旅拍订单",info.getActual_payment(),1,this);
                        break;
                    case 7:
                        //评价
