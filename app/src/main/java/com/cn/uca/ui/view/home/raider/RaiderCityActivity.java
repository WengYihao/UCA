...
public class RaiderCityActivity extends BaseBackActivity implements View.OnClickListener,CollectionClickListener,BuyRaiderImpl {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (list.get(i).isLock()){
                    ...
                    //积分兑换
                    ShowPopupWindow.raiderIntegral(view,RaiderCityActivity.this,list.get(i).getCity_raiders_id(),list.get(i).getPacture_url(),list.get(i).getCity_name(),integral,RaiderCityActivity.this);
                }
            }
        });
    }
