...
import com.cn.uca.R;
import com.cn.uca.adapter.FolderAdapter;
import com.cn.uca.adapter.PhotoAdapter;
import com.cn.uca.bean.util.Photo;
import com.cn.uca.bean.util.PhotoFolder;
import com.cn.uca.util.MPermissionUtils;
import com.cn.uca.util.PhotoUtils;
...
public class PhotoPickerActivity extends BaseBackActivity implements PhotoAdapter.PhotoClickCallBack{
...
//        checkPerm();
    ...
    private void checkPerm() {
         ...
         * */
        if (ContextCompat.checkSelfPermission(PhotoPickerActivity.this, android.Manifest.permission.CAMERA)
...
//        }
    ...
    private void getPhotosSuccess() {
        ...
        mPhotoNumTV.setText(SystemUtil.formatResourceString(getApplicationContext(),
    ...
    public void onPhotoClick() {
        ...
        if (list != null && list.size() > 0) {
            ...
            mCommitBtn.setText(SystemUtil.formatResourceString(getApplicationContext(),
    ...
    private void initAnimation(View dimLayout) {
         ...
         */
        int height = SystemUtil.getWindowHeight(this) - 3 * actionBarHeight;
    ...
    private void showCamera() {
        ...
        if (cameraIntent.resolveActivity(getPackageManager()) != null) {
            // 设置系统相机拍照后的输出路径
            // 创建临时文件
            mTmpFile = SystemUtil.createFile(getApplicationContext());
