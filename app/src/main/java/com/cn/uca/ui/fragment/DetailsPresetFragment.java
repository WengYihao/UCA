...
public class DetailsPresetFragment extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_preset_details,null);
    ...
    private void initView() {
        ...
        String url = "http://119.23.210.252/youkatravel/api/escort/page/routePreset.do?account_token="+SharePreferenceXutil.getAccountToken();
//        String url = "http://119.23.210.252/youkatravel/api/escort/page/routePreset.do?account_token=A560D8AA48CCA433232F7ADD469D1124";
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == FILECHOOSER_RESULTCODE) {
            ...
            Uri result = data == null || resultCode != -1 ? null
                    : data.getData();
            if (result != null) {
                String imagePath = getPath(getActivity(), result);
